...
import {ThemeProvider, Typography, Box, FormControl,TextField, Button, OutlinedInput, FormHelperText, MenuItem, InputLabel} from "@mui/material"
      ...
      sx={{display: 'flex',
        ...
        padding:"0.5rem"}}>
          ...
          <FormControl>
            ...
            <FormControl><CountrySelect /></FormControl>
              
            <FormControl> <YearSelect  /></FormControl>
              
            <FormControl><MajorSelect /></FormControl>
  ...
  const countries = [
    ...
    function CountrySelect(props){
      ...
      return(
         ...
         onInputChange= {(e)=>{{props.setCountry(e.target.value)}}}
